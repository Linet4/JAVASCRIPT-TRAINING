...
function calc_net_salary(gross_salary,nhif,nssf,nhdf,payee){
    let net_salary=gross_salary-(nhif+nssf+nhdf+payee)
    return net_salary
}
let net_salary=calc_net_salary(gross_salary,NHIF,NSSF,NHDF,payee)
